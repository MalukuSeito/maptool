...
public class VBL_Functions extends AbstractFunction {
	 ...
	 */
	public static Area drawRectangleVBL(ZoneRenderer renderer, JSONObject vblObject, boolean erase) throws ParserException {
	 ...
	 *             JSON, throw ParserException
	 */
	public static Area drawPolygonVBL(ZoneRenderer renderer, JSONObject vblObject, boolean erase) throws ParserException {
	 ...
	 *             JSON, throw ParserException
	 */
	public static Area drawCrossVBL(ZoneRenderer renderer, JSONObject vblObject, boolean erase) throws ParserException {
	 ...
	 *             JSON, throw ParserException
	 */
	public static Area drawCircleVBL(ZoneRenderer renderer, JSONObject vblObject, boolean erase) throws ParserException {
	 ...
	 */
	private static Area renderVBL(ZoneRenderer renderer, Area area, boolean erase) {
		if (renderer == null)
			return area;
		if (erase) {
